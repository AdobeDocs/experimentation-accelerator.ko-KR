...
title: Journey Optimizer Experimentation Accelerator 모범 사례
...
# Journey Optimizer Experimentation Accelerator 모범 사례 {#content-experiment-best-practices}
...
| 용어 | 정의 |
|-|-|
| 컨트롤 | 비교를 위한 기준선으로 사용되는 원본 버전입니다. |
